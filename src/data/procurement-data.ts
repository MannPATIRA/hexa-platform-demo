...
export const procurementItems: ProcurementItem[] = [
  ...
  },
  {
    id: "pi-016",
    sku: "HB-M10-40",
    name: "Hex Bolt M10x40mm 25-Pack",
    description: "Grade 8.8 hex bolt, M10 thread, 40mm length. 25 per pack. Used in valve assemblies and pump mounts.",
    source: "erp_alert",
    status: "flagged",
    priority: "critical",
    currentStock: 0,
    reorderPoint: 80,
    maxStock: 400,
    avgDailyConsumption: 5.0,
    avgDailyConsumption30d: 6.2,
    avgDailyConsumption90d: 5.0,
    flaggedAt: "2026-03-27T10:00:00Z",
    requestedBy: "BOM Quote Builder",
    category: "standard_component",
    attachments: [],
    preferredSupplierId: "sup-002",
    stockHistory: generateStockHistory(0, 5.0, 90),
  },
  {
    id: "pi-017",
    sku: "GK-FL-3",
    name: 'Flange Gasket Kit 3"',
    description: "Complete gasket kit for 3-inch flanges, includes bolts and nuts. Low stock alert from BOM analysis.",
    source: "erp_alert",
    status: "flagged",
    priority: "high",
    currentStock: 18,
    ...
    avgDailyConsumption30d: 4.8,
    avgDailyConsumption90d: 3.5,
    flaggedAt: "2026-03-27T10:00:00Z",
    requestedBy: "BOM Quote Builder",
    category: "standard_component",
    attachments: [],
    preferredSupplierId: "sup-002",
    stockHistory: generateStockHistory(18, 3.5, 90),
  },
];
